...
if flag == 1
    export_data = struct('time',time,'eng_strain1',eng_strain1,'eng_strain3',eng_strain3, ...
        ...
        'force_3',force_3,'vel_1',vel_1,'vel_3',vel_3, ...
         ...
         'Adjusted_Incident_Voltage',(volt_i - null_i) * fact_i,'Adjusted_Reflected_Voltage',(volt_r - null_i) * fact_i,...
         'Adjusted_Transmitted_Voltage',(volt_t - null_t) * fact_t,'Export_Date',datestr(datetime('now')));
     if ~isempty(dataset.material)
